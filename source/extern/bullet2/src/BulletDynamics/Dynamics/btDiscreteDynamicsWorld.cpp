...
int	btDiscreteDynamicsWorld::stepSimulation( btScalar timeStep,int maxSubSteps, btScalar fixedTimeStep)
{
	...
	//}
	// Ensure m_localTime stays in valid range [0, fixedTimeStep)  
	//m_localTime = btMax(btScalar(0.0), btMin(m_localTime, fixedTimeStep));
	...
	{
		/// not sure if it's needed but is - a lot without on start frame
