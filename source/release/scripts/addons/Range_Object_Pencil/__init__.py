...
def menu_vertex_paint_func(self, context):
    ...
    self.layout.menu(vertex_paint.MFTVertexPaintMenu.bl_idname)
...
range_tools.MFTPanelPose,
range_tools.MFTPanelAnimation,
range_tools.MFTPanelPlaykot,
range_tools.MFTSceneRender2X,
range_tools.MFTCropNodeRegion,
range_tools.MFTCropToViewport,
range_tools.MFTOutputCreator,
range_tools.MFTCurveAnimator,
range_tools.MFTMorfCreator,
range_tools.MFTCopyBonesTransform,
]
