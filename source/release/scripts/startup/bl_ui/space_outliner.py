...
class OUTLINER_HT_header(Header):
    ...
    def draw(self, context):
        ...
        layout.label(text=bpy.path.basename(filepath) if filepath else "<unsaved>")
...
class OUTLINER_MT_scene_add(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("scene.new", text="New", icon='ZOOMIN').type = 'NEW'
        layout.operator("scene.new", text="Copy Settings").type = 'EMPTY'
        layout.operator("scene.new", text="Link Objects").type = 'LINK_OBJECTS'
        layout.operator("scene.new", text="Link Object Data").type = 'LINK_OBJECT_DATA'
        layout.operator("scene.new", text="Full Copy").type = 'FULL_COPY'
