...
class DATA_PT_metaball(DataButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Metaball:", icon="OUTLINER_DATA_META")
        split = box.split()
        ...
        box.row().prop(mball, "update_method", expand=True)
...
class DATA_PT_mball_texture_space(DataButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box.prop(mball, "use_auto_texspace")
...
class DATA_PT_metaball_element(DataButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Active Element:", icon="OUTLINER_DATA_META")
        box.prop(metaelem, "type")
...
classes = (
    ...
    # DATA_PT_custom_props_metaball,  # disabled: Custom Properties panel unused
)
