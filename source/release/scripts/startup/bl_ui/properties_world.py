...
class WORLD_PT_world(WorldButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        # Camera Exposure is drawn in the Environment panel below.
...
class WORLD_PT_ambient_occlusion(WorldButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Ambient Occlusion:", icon="GROUP")
        split = box.split()
...
class WORLD_PT_environment_lighting(WorldButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Environment Lighting:", icon="LAMP_HEMI")
        split = box.split()
...
class WORLD_PT_indirect_lighting(WorldButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Indirect Lighting:", icon="LAMP_AREA")
        split = box.split()
        split.prop(light, "indirect_factor", text="Factor")
        split.prop(light, "indirect_bounces", text="Bounces")

        if light.gather_method == 'RAYTRACE':
            box.label(text="Only works with Approximate gather method")
...
class WORLD_PT_gather(WorldButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Gather Method:", icon="FORCE_HARMONIC")
        box.row().prop(light, "gather_method", expand=True)

        box = layout.box()
        box.label(text="Attenuation:", icon="MOD_FLUIDSIM")
        split = box.split()
        ...
        if light.gather_method == 'APPROXIMATE':
            box = layout.box()
            box.label(text="Sampling:", icon="SETTINGS")
            col = box.column()
...
class WORLD_PT_mist(WorldButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Mist:", icon="MOD_FLUIDSIM")
        split = box.split()
        ...
        box.prop(world.mist_settings, "falloff")
...
classes = (
    ...
    WORLD_PT_gather,
    WORLD_PT_mist,
    # WORLD_PT_custom_props,  # disabled: Custom Properties panel unused
)
