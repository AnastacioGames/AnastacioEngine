...
class BONE_PT_transform(BoneButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Transform:", icon="BONE_DATA")
...
class BONE_PT_transform_locks(BoneButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Transform Locks:", icon="LOCKED")
...
class BONE_PT_curved(BoneButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Bendy Bones:", icon="BONE_DATA")
        box.prop(bone, "bbone_segments", text="Segments")
        ...
        if pchan:
            ...
            box2 = layout.box()
            box2.label(text="Custom Handles:", icon="HAND")
            box2.prop(pchan, "use_bbone_custom_handles")
...
class BONE_PT_relations(BoneButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Relations:", icon="GROUP_BONE")
        split = box.split()
...
class BONE_PT_inverse_kinematics(BoneButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Inverse Kinematics:", icon="CONSTRAINT_BONE")
        row = box.row()
...
classes = (
    ...
    BONE_PT_deform,
    # BONE_PT_custom_props,  # disabled: Custom Properties panel unused
)
