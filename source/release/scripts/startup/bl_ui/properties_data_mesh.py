...
class DATA_PT_normals(MeshButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Normals:", icon="MESH_DATA")
        split = box.split()
...
class DATA_PT_texture_space(MeshButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box.prop(mesh, "texture_mesh")

        box.separator(factor=1)

        box.prop(mesh, "use_auto_texspace")
        row = box.row()
...
class DATA_PT_uv_texture(MeshButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="UV Maps:", icon="GROUP_UVS")
        row = box.row()
        col = row.column()
...
class DATA_PT_vertex_colors(MeshButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Vertex Colors:", icon="GROUP_VCOL")
        row = box.row()
        col = row.column()
...
class DATA_PT_customdata(MeshButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Geometry Data:", icon="MESH_DATA")
        col = box.column()
...
classes = (
    ...
    DATA_PT_customdata,
    # DATA_PT_custom_props_mesh,  # disabled: Custom Properties panel unused
)
