...
class OBJECT_PT_transform(ObjectButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Transform:", icon="MAN_TRANS")
        row = box.row()
...
class OBJECT_PT_delta_transform(ObjectButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Delta Transform:", icon="MAN_TRANS")
        row = box.row()
...
class OBJECT_PT_transform_locks(ObjectButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Locks:", icon="LOCKED")
...
class OBJECT_PT_relations(ObjectButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Relations:", icon="CONSTRAINT")
        split = box.split()
...
class OBJECT_PT_relations_extras(ObjectButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text="Relations Extras:", icon="CONSTRAINT")
        split = box.split()
        ...
        box2 = layout.box()
        box2.label(text="Recalculate:", icon="RECOVER_LAST")
        box2.prop(ob, "use_extra_recalc_object")
        box2.prop(ob, "use_extra_recalc_data")
...
class OBJECT_PT_duplication(ObjectButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        if ob.dupli_type == 'FRAMES':
            box = layout.box()
            box.label(text="Frames:", icon="MOD_ARRAY")
            split = box.split()
            ...
            box.prop(ob, "use_dupli_frames_speed", text="Speed")

        elif ob.dupli_type == 'VERTS':
            box = layout.box()
            box.label(text="Vertices:", icon="MOD_ARRAY")
            box.prop(ob, "use_dupli_vertices_rotation", text="Rotation")

        elif ob.dupli_type == 'FACES':
            box = layout.box()
            box.label(text="Faces:", icon="MOD_ARRAY")
            row = box.row()
            ...
            box = layout.box()
            box.label(text="Group:", icon="GROUP")
            box.prop(ob, "dupli_group", text="Group")
...
classes = (
    ...
    # OBJECT_PT_custom_props,  # disabled: Custom Properties panel unused
)
