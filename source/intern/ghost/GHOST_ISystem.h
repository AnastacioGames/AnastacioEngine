...
public:
	 ...
	 * \param enable 	Condition to switch modes.
	 * \param window 	A pointer to the window that will be changed.
	 */
	virtual void setFullScreen(bool enable, GHOST_IWindow *window) = 0;
