...
/* only used on drawobject.c */
ImBuf *view3D_icons[9];
...
void ED_view3d_icons_init(Main *bmain) {
	// Loading images from Memory.
	const uchar *icon_data;
	size_t icon_data_size;

	extern int datatoc_view3d_camera_inactive_icon_png_size;
	extern char datatoc_view3d_camera_inactive_icon_png[];

	extern int datatoc_view3d_camera_icon_png_size;
	extern char datatoc_view3d_camera_icon_png[];

	extern int datatoc_view3d_lamp_png_size;
	extern char datatoc_view3d_lamp_png[];

	extern int datatoc_view3d_sunlamp_png_size;
	extern char datatoc_view3d_sunlamp_png[];

	extern int datatoc_view3d_spotlamp_png_size;
	extern char datatoc_view3d_spotlamp_png[];

	extern int datatoc_view3d_hemilamp_png_size;
	extern char datatoc_view3d_hemilamp_png[];

	extern int datatoc_view3d_arealamp_png_size;
	extern char datatoc_view3d_arealamp_png[];

	extern int datatoc_view3d_script_png_size;
	extern char datatoc_view3d_script_png[];

	extern int datatoc_view3d_speaker_png_size;
	extern char datatoc_view3d_speaker_png[];

	/* allocate ICON_3D_CAMERA_INACTIVE in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_camera_inactive_icon_png;
	icon_data_size = datatoc_view3d_camera_inactive_icon_png_size;
	view3D_icons[ICON_3D_CAMERA_INACTIVE] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_CAMERA_INACTIVE");
	
	/* allocate ICON_3D_CAMERA in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_camera_icon_png;
	icon_data_size = datatoc_view3d_camera_icon_png_size;
	view3D_icons[ICON_3D_CAMERA] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_LAMP");
	
	/* allocate ICON_3D_LAMP in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_lamp_png;
	icon_data_size = datatoc_view3d_lamp_png_size;
	view3D_icons[ICON_3D_LAMP] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_LAMP");

	/* allocate ICON_3D_SUNLAMP in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_sunlamp_png;
	icon_data_size = datatoc_view3d_sunlamp_png_size;
	view3D_icons[ICON_3D_SUNLAMP] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_SUNLAMP");

	/* allocate ICON_3D_SPOTLAMP in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_spotlamp_png;
	icon_data_size = datatoc_view3d_spotlamp_png_size;
	view3D_icons[ICON_3D_SPOTLAMP] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_SPOTLAMP");

	/* allocate ICON_3D_HEMILAMP in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_hemilamp_png;
	icon_data_size = datatoc_view3d_hemilamp_png_size;
	view3D_icons[ICON_3D_HEMILAMP] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_HEMILAMP");

	/* allocate ICON_3D_AREALAMP in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_arealamp_png;
	icon_data_size = datatoc_view3d_arealamp_png_size;
	view3D_icons[ICON_3D_AREALAMP] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_AREALAMP");

	/* allocate ICON_3D_SCRIPT in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_script_png;
    icon_data_size = datatoc_view3d_script_png_size;
	view3D_icons[ICON_3D_SCRIPT] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_SCRIPT");

	/* allocate ICON_3D_SPEAKER in view3D_icons */
	icon_data = (const uchar *)datatoc_view3d_speaker_png;
    icon_data_size = datatoc_view3d_speaker_png_size;
	view3D_icons[ICON_3D_SPEAKER] = IMB_ibImageFromMemory(icon_data, icon_data_size, IB_rect, NULL, "ICON_3D_SPEAKER");
}

void ED_view3d_icons_free(void) {
  for (int i = 0; i < ICON_3D_END; i++) {
    IMB_freeImBuf(view3D_icons[i]);
  }
}
...
void ED_spacetype_view3d(void)
{
	...
	art->keymapflag = ED_KEYMAP_GPENCIL | ED_KEYMAP_UI;
