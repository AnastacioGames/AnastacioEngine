...
void ED_operatortypes_object(void)
{
	...
	WM_operatortype_append(OBJECT_OT_game_components_copy);
	...
	WM_operatortype_append(OBJECT_OT_vehicle_wheel_add);
	WM_operatortype_append(OBJECT_OT_vehicle_wheel_remove);
	WM_operatortype_append(OBJECT_OT_vehicle_gear_add);
	WM_operatortype_append(OBJECT_OT_vehicle_gear_remove);

	WM_operatortype_append(OBJECT_OT_animation_event_add);
	WM_operatortype_append(OBJECT_OT_animation_event_remove);
	WM_operatortype_append(OBJECT_OT_animation_event_trigger_add);
	WM_operatortype_append(OBJECT_OT_animation_event_trigger_remove);
	WM_operatortype_append(OBJECT_OT_animation_event_trigger_pick);
	WM_operatortype_append(OBJECT_OT_animation_event_move_up);
	WM_operatortype_append(OBJECT_OT_animation_event_move_down);

	WM_operatortype_append(CUTSCENE_OT_sequence_add);
	WM_operatortype_append(CUTSCENE_OT_sequence_remove);
	WM_operatortype_append(CUTSCENE_OT_sequence_duplicate);
	WM_operatortype_append(CUTSCENE_OT_sequence_move);
	WM_operatortype_append(CUTSCENE_OT_event_add);
	WM_operatortype_append(CUTSCENE_OT_event_remove);
	WM_operatortype_append(CUTSCENE_OT_event_duplicate);
	WM_operatortype_append(CUTSCENE_OT_event_move);
