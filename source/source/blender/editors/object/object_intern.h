...
void OBJECT_OT_game_components_copy(struct wmOperatorType *ot);
...
/* object_vehicle.c */
void OBJECT_OT_vehicle_wheel_add(struct wmOperatorType *ot);
void OBJECT_OT_vehicle_wheel_remove(struct wmOperatorType *ot);
void OBJECT_OT_vehicle_gear_add(struct wmOperatorType *ot);
void OBJECT_OT_vehicle_gear_remove(struct wmOperatorType *ot);

/* object_animation_event.c */
void OBJECT_OT_animation_event_add(struct wmOperatorType *ot);
void OBJECT_OT_animation_event_remove(struct wmOperatorType *ot);
void OBJECT_OT_animation_event_trigger_add(struct wmOperatorType *ot);
void OBJECT_OT_animation_event_trigger_remove(struct wmOperatorType *ot);
void OBJECT_OT_animation_event_trigger_pick(struct wmOperatorType *ot);
void OBJECT_OT_animation_event_move_up(struct wmOperatorType *ot);
void OBJECT_OT_animation_event_move_down(struct wmOperatorType *ot);

/* object_cutscene.c */
void CUTSCENE_OT_sequence_add(struct wmOperatorType *ot);
void CUTSCENE_OT_sequence_remove(struct wmOperatorType *ot);
void CUTSCENE_OT_sequence_duplicate(struct wmOperatorType *ot);
void CUTSCENE_OT_sequence_move(struct wmOperatorType *ot);
void CUTSCENE_OT_event_add(struct wmOperatorType *ot);
void CUTSCENE_OT_event_remove(struct wmOperatorType *ot);
void CUTSCENE_OT_event_duplicate(struct wmOperatorType *ot);
void CUTSCENE_OT_event_move(struct wmOperatorType *ot);
