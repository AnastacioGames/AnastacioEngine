...
static uiStyle *ui_style_new(ListBase *styles, const char *name, short uifont_id)
{
	...
	style->widgetlabel.points = UI_DEFAULT_TITLE_POINTS;
	...
	style->widget.points = UI_DEFAULT_TITLE_POINTS;
...
void uiStyleInit(void)
{
	...
	int monofont_size = datatoc_roboto_mono_medium_ttf_size;
	uchar *monofont_ttf = (uchar *)datatoc_roboto_mono_medium_ttf;
