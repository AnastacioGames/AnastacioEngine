...
void WORLD_OT_game_property_new(struct wmOperatorType *ot);
void WORLD_OT_game_property_remove(struct wmOperatorType *ot);
void WORLD_OT_game_property_move(struct wmOperatorType *ot);
