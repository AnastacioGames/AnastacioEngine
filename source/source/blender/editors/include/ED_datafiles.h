...
extern int datatoc_roboto_medium_pfb_size;
extern char datatoc_roboto_medium_pfb[];
...
extern int datatoc_forkawesome_icon_font_ttf;
extern char datatoc_forkawesome_icon_font_ttf_size[];
