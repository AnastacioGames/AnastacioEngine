...
/* Referenced only by gpu_codegen.c's appended tangent-attribute code below, unused
 * by this file's own main() (the world sphere is drawn directly in clip space). */
