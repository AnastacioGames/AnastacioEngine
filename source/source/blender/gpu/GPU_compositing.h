...
typedef enum GPUFXShaderEffect {
	...
	/* SCENE FX Shaders section */
	/* Bloom shader */
	GPU_SHADER_FX_BLOOM = 11,
	/* Tonemap shader */
	GPU_SHADER_FX_TONEMAP = 12,
	/* Light Scatter shader */
	GPU_SHADER_FX_LIGHTSCATTER = 13,
...
bool GPU_fx_compositor_initialize_passes(
        struct Scene *scene, GPUFX *fx, const struct rcti *rect, const struct rcti *scissor_rect,
