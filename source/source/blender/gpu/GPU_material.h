...
/* Max bone matrices uploaded as a uniform array for GPU skinning (see BL_SkinDeformer).
 * Kept here so both the GLSL codegen (gpu_shader.c) and the game engine deformer
 * (BL_SkinDeformer.cpp) share a single budget. */
#define GPU_MAX_SKINNING_BONES 64
...
typedef enum GPUDynamicType {
	...
	GPU_DYNAMIC_LAMP_DYNAREARIGHT	 =	8 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_DYNAREAUP		 =	9 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_DYNAREASIZE	 = 10 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_DISTANCE		 = 11 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_ATT1			 = 12 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_ATT2			 = 13 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_SPOTSIZE		 = 14 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_SPOTBLEND		 = 15 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_COEFFCONST	   	 = 16 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_COEFFLIN		 = 17 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_COEFFQUAD		 = 18 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_CUTOFF			 = 19 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_DYNVISI		 = 20 | GPU_DYNAMIC_GROUP_LAMP,
	...
	GPU_DYNAMIC_MIST_HEIGHT          = 7  | GPU_DYNAMIC_GROUP_MIST,
	GPU_DYNAMIC_MIST_DENSITY         = 8  | GPU_DYNAMIC_GROUP_MIST,
	...
	GPU_DYNAMIC_NADIR_COLOR			 = 4  | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_LINFAC         = 5  | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_LOGFAC         = 6  | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_SUN_DIRECTION	 = 7  | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_SUN_COLOR		 = 8  | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_SUN_ENERGY	 = 9  | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_SUN_SIZE       = 10 | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_ENVLIGHT_ENERGY      = 11 | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_MOON_ENABLED   = 12 | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_MOON_SIZE      = 13 | GPU_DYNAMIC_GROUP_WORLD,
	GPU_DYNAMIC_WORLD_MOON_BRIGHTNESS = 14 | GPU_DYNAMIC_GROUP_WORLD,
...
typedef struct GPUShadeInput {
	...
	GPUNodeLink *alpha, *refl, *spec, *emit, *har, *amb, *translucency;
...
/* Cascaded Shadow Mapping (Sun lamps only). Cascade 0 = Medium, 1 = Low; the Near cascade is the
 * lamp itself (its own winmat/viewmat/depthtex/etc. fields, same as a non-CSM Sun lamp). */
