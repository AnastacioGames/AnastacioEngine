...
void BKE_object_vehicle_wheel_add(struct Object *ob);
bool BKE_object_vehicle_wheel_remove(struct Object *ob, int index);
void BKE_object_vehicle_gear_add(struct Object *ob);
bool BKE_object_vehicle_gear_remove(struct Object *ob, int index);
