...
typedef struct Material {
	...
	ListBase gpumaterialskinning;		/* runtime */
} Material;
...
#define GEMAT_MULTIPLY			(1 << 5) /* GPU_BLEND_MULTIPLY */
...
#define MA_TWOSIDEDSHADOWS  (1 << 3)
#define MA_USEFULLSKY	    (1 << 4) /* Full sky */
...
#define MA_FOLIAGE			64
#define MA_SKINNING			128
...
#define MA_RAMP_IN_ALBEDO_R	4
#define MA_RAMP_IN_ALBEDO_G	5
#define MA_RAMP_IN_ALBEDO_B	6
