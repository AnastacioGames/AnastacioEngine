...
typedef struct bArmature {
	...
	int         gearmculling;			/* culling method for armature in ge */
	short       deformflag;
	short       pathflag;
...
typedef enum eArmature_VertDeformer {
	ARM_VDEF_BLENDER = 0,
	ARM_VDEF_BGE_CPU = 1,
	ARM_VDEF_BGE_NORMALS_CPU = 2,
	ARM_VDEF_BGE_GPU = 3,
} eArmature_VertDeformer;

/* armature->gearmculling */
typedef enum eArmature_CullingMethod {
	ARM_CDEF_FULL = 0,
	ARM_CDEF_NONE = 1,
} eArmature_CullingMethod;
