...
typedef struct bTheme {
	...
	ThemeSpace tglobal;
	ThemeUI tglobal_ui;
	int global_theme_spaces, global_theme_spaces_pad;
...
typedef struct UserDef {
	...
	int rangeversionfile, rangesubversionfile, rangeminsubversionfile;
	...
	short header_size;   /* height of area headers in pixels, 0 = use built-in default (HEADERY) */
	short _pad0;
