...
typedef struct bPropertyActuator {
	...
	struct Object *ob;
	short runtime_enabled;
	short runtime_property;
	short runtime_bool_value;
	short use_world_property;	/* read/write the property on the current World instead of the Object */
	float runtime_value[3];
	float runtime_pad2;
} bPropertyActuator;
...
typedef struct bGameActuator {
	...
	int sta, end;
	char filename[64];
	char saveloc[64], extension_name[64]; /* for save/load globaldict */
	char loadaniname[64];
} bGameActuator;
...
typedef struct bActuator {
	...
	char pad[5];
	char color[3]; /* controller color (bController controls this) */
...
#define ACT_OBJECT_NORMAL_SET   3
...
/* bPropertyActuator.runtime_property */
#define ACT_RUNTIME_PROP_LOCAL_POSITION	0
#define ACT_RUNTIME_PROP_VISIBLE			1
#define ACT_RUNTIME_PROP_MASS				2
#define ACT_RUNTIME_PROP_LINEAR_VELOCITY	3
#define ACT_RUNTIME_PROP_ANGULAR_VELOCITY	4
#define ACT_RUNTIME_PROP_GRAVITY			5
#define ACT_RUNTIME_PROP_LOCAL_SCALE		6
#define ACT_RUNTIME_PROP_WEATHER_RAIN_INTENSITY 7
#define ACT_RUNTIME_PROP_WEATHER_RAIN_DENSITY 8
#define ACT_RUNTIME_PROP_WEATHER_RAIN_SPEED 9
#define ACT_RUNTIME_PROP_WEATHER_RAIN_WIND 10
#define ACT_RUNTIME_PROP_WEATHER_RAIN_DARKEN 11
#define ACT_RUNTIME_PROP_WEATHER_RIPPLE_INTENSITY 12
#define ACT_RUNTIME_PROP_WEATHER_RAIN 13
#define ACT_RUNTIME_PROP_WEATHER_RIPPLES 14
#define ACT_RUNTIME_PROP_WEATHER_CLOUDS 15
#define ACT_RUNTIME_PROP_WEATHER_CLOUD_COVERAGE 16
#define ACT_RUNTIME_PROP_WEATHER_CLOUD_SCALE 17
#define ACT_RUNTIME_PROP_WEATHER_CLOUD_SPEED 18
#define ACT_RUNTIME_PROP_WEATHER_LENS_FLARE 19
#define ACT_RUNTIME_PROP_WEATHER_FLARE_SCALE 20
#define ACT_RUNTIME_PROP_WEATHER_FLARE_INTENSITY 21
#define ACT_RUNTIME_PROP_WEATHER_MIST 22
#define ACT_RUNTIME_PROP_WEATHER_MIST_INTENSITY 23
#define ACT_RUNTIME_PROP_WEATHER_MIST_START 24
#define ACT_RUNTIME_PROP_WEATHER_MIST_DEPTH 25
#define ACT_RUNTIME_PROP_WEATHER_MIST_HEIGHT 26
#define ACT_RUNTIME_PROP_WEATHER_MIST_DENSITY 27
...
#define ACT_2DFILTER_OUTLINE	        13
#define ACT_2DFILTER_SSAO				14
#define ACT_2DFILTER_BLOOM				15
#define ACT_2DFILTER_TONEMAP			16
#define ACT_2DFILTER_LIGHTSCATTER		17
#define ACT_2DFILTER_SSR				18
#define ACT_2DFILTER_FXAA				19
#define ACT_2DFILTER_NUMBER_OF_FILTERS	20
