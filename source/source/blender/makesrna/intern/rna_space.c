...
const EnumPropertyItem rna_enum_space_type_items[] = {
	...
	{SPACE_LOGIC, "LOGIC_EDITOR", ICON_LOGIC, "Logic Bricks Editor", "Logic bricks editor"},
...
static const EnumPropertyItem buttons_context_items[] = {
	...
	{BCONTEXT_GAME, "GAME", ICON_FILE_SCRIPT, "Game", "Game Object Properties"},
	{BCONTEXT_TEXTURE, "TEXTURE", ICON_TEXTURE, "Texture", "Texture"},
	{BCONTEXT_PARTICLE, "PARTICLES", ICON_PARTICLES, "Particles", "Particle"},
	{BCONTEXT_PHYSICS, "PHYSICS", ICON_PHYSICS, "Physics", "Physics"},
	{BCONTEXT_VEHICLE, "VEHICLE", ICON_AUTO, "Vehicle", "Vehicle"},
	{0, NULL, 0, NULL, NULL}
};
                                                           ...
                                                           PropertyRNA *UNUSED(prop), bool *r_free)
{
	...
	if (sbuts->pathflag & (1 << BCONTEXT_VEHICLE)) {
		RNA_enum_items_add_value(&item, &totitem, buttons_context_items, BCONTEXT_VEHICLE);
	}
...
static void rna_def_space_view3d(BlenderRNA *brna)
{
	...
	RNA_def_property_boolean_sdna(prop, NULL, "flag2", V3D_SHOW_MIST);
...
static void rna_def_space_buttons(BlenderRNA *brna)
{
	...
	prop = RNA_def_property(srna, "context_valid_flag", PROP_INT, PROP_UNSIGNED);
	RNA_def_property_int_sdna(prop, NULL, "pathflag");
	RNA_def_property_clear_flag(prop, PROP_EDITABLE);
	RNA_def_property_ui_text(prop, "Context Valid Flag",
	                          "Internal bitmask of which Context tabs are valid for the current selection "
	                          "(bit N set means the tab with enum value N can be displayed)");
