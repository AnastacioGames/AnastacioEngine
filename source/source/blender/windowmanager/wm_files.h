...
void        WM_OT_save_as_mainfile_protected(struct wmOperatorType *ot);
...
void        WM_OT_link_to_libload(struct wmOperatorType *ot);
void        WM_OT_import_libload_text(struct wmOperatorType *ot);
