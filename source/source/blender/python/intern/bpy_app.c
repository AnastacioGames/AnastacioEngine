...
static PyStructSequence_Field app_info_fields[] = {
	...
	{(char *)"range_version", (char *)"The RanGE version as a tuple of 3 numbers. eg. (1, 5, 1)"},
	{(char *)"range_version_string", (char *)"The RanGE version formatted as a string"},
...
#define SetObjItem(obj) \
	...
	SetObjItem(PyC_Tuple_Pack_I32(RANGE_VERSION, RANGE_SUBVERSION, RANGE_MINSUBVERSION));
	SetObjItem(PyUnicode_FromFormat("%d.%d.%d",
