...
{
	// Free every attachment that was actually allocated, even if creation failed partway
	// through (m_frameBuffer nullptr) and left earlier slots holding live GPU resources.
	if (m_frameBuffer) {
		GPU_framebuffer_free(m_frameBuffer);
	}
