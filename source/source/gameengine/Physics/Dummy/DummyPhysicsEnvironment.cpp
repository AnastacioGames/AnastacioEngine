...
void DummyPhysicsEnvironment::ProceedDeltaTimeCar(double timeStep, double interval)
{
...
//changed 3-20-2025
void DummyPhysicsEnvironment::ProceedDeltaTime(double timeStep, double interval)
{
	//step physics simulation, typically perform
...
void DummyPhysicsEnvironment::DestroyVehicle(PHY_IVehicle *vehicle)
{
}
