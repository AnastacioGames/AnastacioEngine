...
public:
	...
	/**
	 * Shift this controller's center of mass away from its node/graphics
	 * origin by \a localOffset (object local space), without moving the
	 * visible object. No-op unless the backend supports it and the
	 * collision shape has already been arranged for it (see
