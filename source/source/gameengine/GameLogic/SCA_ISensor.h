...
protected:
	...
	/// Use DeltaTime in skipped_ticks.
	bool m_use_dt;
...
public:
	...
	/// Workaround to fix crash
	bool m_replaced_with_Libload;
	...
	/** Called when an object referenced by this sensor is deleted. */
	 ...
	 */
	void SetPulseMode(bool posmode, bool negmode, float skippedticks);

	/** Set inversion of pulses on or off. */
	void SetInvert(bool inv);
	/** set the level detection on or off */
	void SetLevel(bool lvl);
	void SetDeltaTime(bool lvl);
