...
protected:
	...
	/// Sensors that use a pointer to this object.
	SCA_SensorList m_registeredSensors;
...
public:
	...
	void RegisterSensor(SCA_ISensor *sens);
	void UnregisterSensor(SCA_ISensor *sens);
	...
	virtual bool GetRuntimeProperty(const char *identifier,
	                                SCA_RuntimePropertyValue& value,
	                                const char **error = nullptr);
	virtual bool SetRuntimeProperty(const char *identifier,
