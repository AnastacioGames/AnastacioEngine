...
public:
	...
	/// Convert the Custom Mouse Cursor.
	void ConvertCustomMouseCursor(KX_Scene *start_scene, const char *filepath);
	...
	/** Find an Object of the given name directly in bmain (e.g. one linked via
	 * WM_OT_link_to_libload but never instantiated in any scene) and convert it into a
	 * KX_GameObject merged into scene_merge's inactive list, ready to be replicated by
