...
public:
	...
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,SetWheelIsDriveWheel);
	...
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,GetCurrentSpeedKmh);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,GetCurrentSpeedMps);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,GetForwardVector);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,GetCoordinateSystem);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,SetCoordinateSystem);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,ResetSuspension);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,GetWheelConfig);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,GetWheelState);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,SavePreset);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,LoadPreset);
	EXP_PYMETHOD_VARARGS(KX_VehicleWrapper,RebuildPreset);
...
private:
	static void OnVehicleInvalidated(void *client);
