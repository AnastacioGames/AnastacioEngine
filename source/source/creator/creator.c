...
#undef main
	...
	/* RanGE: font icons, only used in debug mode */
	BKE_vfont_builtin_register(datatoc_forkawesome_icon_font_ttf, datatoc_forkawesome_icon_font_ttf_size);

	/* background render uses this font too */
	BKE_vfont_builtin_register(datatoc_roboto_medium_pfb, datatoc_roboto_medium_pfb_size);
