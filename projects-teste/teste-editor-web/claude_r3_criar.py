"""Gera claude-r3-probe.range (controller claude_r3_probe.rodar: audio invalido no Web).
Uso: RangeEngine.exe -b --python claude_r3_criar.py   (grava ao lado deste arquivo)"""
import os
import bpy

out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "claude-r3-probe.range")
...
c.mode = 'MODULE'
c.module = 'claude_r3_probe.rodar'
