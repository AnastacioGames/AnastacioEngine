...
Uso: RangeEngine.exe -b --python criar_m1c.py   (grava ao lado deste arquivo)"""
import os
import bpy

out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "m1c-shader.range")
...
me.update()
mat = bpy.data.materials.new('MatQuebrado')
...
c.mode = 'MODULE'
c.module = 'shader_quebrado.quebrar'
