...
- **M3 (Claude), em andamento:** correcoes de indice de filtro, resize do bloom e timer de GPU implementadas e compiladas; so a colisao de indice tem teste de runtime (antes/depois). Faltam o teste de resize com bloom ligado, o de resolucao dinamica sem timer, as medicoes em celular fisico e a decisao do M4. Detalhes no changelog de 2026-09-20.
